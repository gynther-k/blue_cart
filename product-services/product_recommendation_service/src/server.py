...
class InfoServicer(Info_pb2_grpc.InfoServicer):
    ...
    def GetInfo(self, request, context):
        ...
        res = Controller.retrieve_recommendation_by_product_id(mongodbconnection,request.productid)
        ...
        response.mapfield["recommendedproductid"]=res['product_Id']
        response.mapfield["recommendedproductname"]=res['Recommended_product_name']
        response.mapfield["recommendedproductprice"]=res['Recommended_product_price']
