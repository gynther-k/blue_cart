...
channel.queue_declare(queue='product-recommendation-service-q')

def on_request(ch, method, props, body):
    pid = str(body)

    response = Controller.retrieve_recommendation_by_product_id(mongodbconnection,pid)
...
channel.basic_consume(queue='product-recommendation-service-q', on_message_callback=on_request)
