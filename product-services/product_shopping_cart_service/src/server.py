...
channel.queue_declare(queue='customer-shopping-cart-q')

def on_request(ch, method, props, body):

    cid = str(int(body))

    response = Controller.retrieve_shopping_cart_by_customer_id(mongodbconnection,cid)
...
channel.basic_consume(queue='customer-shopping-cart-q', on_message_callback=on_request)
