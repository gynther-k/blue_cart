...
def on_request(message):
    ...
    response = str(Controller.retrieve_review_By_Product_Id(mongodbconnection,pid))
...
CHANNEL.queue.declare(queue='product-review-service-q')
CHANNEL.basic.qos(prefetch_count=1)
CHANNEL.basic.consume(on_request, queue='product-review-service-q')
